...
from .serializers import ImageSerializer, PostSerializer, CategorySerializer, CommentSerializer, LikesSerializer, \
    RatingSerializer, ParsingSerializer, FavoriteSerializer
